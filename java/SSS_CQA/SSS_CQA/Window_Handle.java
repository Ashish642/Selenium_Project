...
//		driver.findElement(By.xpath("//a[normalize-space()='Register now']")).click();
	...
	public void handleTabs_using_getWindowHandles() {
		...
		//enter username
		driver.findElement(By.xpath("//input[@id='txtUsername']")).sendKeys("Ashish");
		//enter password
		driver.findElement(By.xpath("//input[@id='txtPassword']")).sendKeys("amart");
...
//		driver.close();
	...
	@Test
//	write the below selenium code to run the .exe file
	public void autoIT_Example() throws AWTException, IOException {
		driver.get("https://opensource-demo.orangehrmlive.com/");
		...
		run.exec("C:\\Users\\DELL\\Desktop\\WebTechnology\\print2.exe");
		driver.close();
	...
	public void webTable_Example() {
		driver.get("file:///C:/Users/DELL/Desktop/webtable.html");
	...
	public void student_Marks() {
		driver.get("file:///C:/Users/DELL/Desktop/stu.html");
		//Count Total number of rows present in the table
		List<WebElement> allRows = driver.findElements(By.xpath("//tr"));
		int totalRows = allRows.size();
		System.out.println("total number of rows present in the table is :"+ totalRows);
